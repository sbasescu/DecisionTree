...
public class TestClassifier {
    ...
    public static void main(String[] args) throws FileNotFoundException {
    	...
    	else if (args.length == 2 && args[0].equals("Custom")) { // Custom solver case, takes the arguments "Custom" and "big" to run
    		exampleCount = 100;
			featureCount = 10;
    		testClassifier("Custom", "big"); // for testing custom data
    	}
